...
public class CookPage extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        findViewById(R.id.btnAddMeal).setOnClickListener(view -> {
            Intent launchActivity = new Intent(getApplicationContext(), IndividualMeal.class).putExtra("mealInfo", new int[]{});
        ...
        String[] projection = {"cook_email","meal_name","meal_type","cuisine_type","description","allergens","ingredients","price","currently_offered","meal_id"};
        ...
        while(cursor.moveToNext()) {
            String[] row = { cursor.getString(cursor.getColumnIndexOrThrow("meal_name")),
                    ...
                    cursor.getString(cursor.getColumnIndexOrThrow("currently_offered")), //Will be 0 or 1
